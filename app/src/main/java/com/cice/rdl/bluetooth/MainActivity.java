package com.cice.rdl.bluetooth;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (adaptadorbluetooth == null) {
            ...
            Toast.makeText(getApplicationContext(),
                    "El dispositivo Bluetooth no está disponible", Toast.LENGTH_LONG).show();
        ...
        btnhabilitar.setOnClickListener(new OnClickListener(){
    ...
    public void habilitarBluetooth()
    {
        if (!adaptadorbluetooth.isEnabled()) {
            ...
            Toast.makeText(getApplicationContext(),
                    "El dispositivo BLUETOOTH YA ESTÁ HABILITADO", Toast.LENGTH_SHORT).show();
        }
    }
